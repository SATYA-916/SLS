  ...
  if (email?.trim().toLowerCase() === ownerEmail.trim().toLowerCase()) {
    try {
      await sendBrevo({
        to: ownerEmail,
        toName: 'SLS Admin',
        subject: 'Admin Password Recovery — SLS STRUCTO MECH CONSULTANTS',
        html: `
          <div style="font-family:sans-serif;max-width:500px;margin:0 auto;color:#333">
            <div style="background:#0a1628;padding:20px 24px">
              ...
              <p style="color:rgba(255,255,255,0.6);margin:4px 0 0;font-size:12px">SLS STRUCTO MECH CONSULTANTS</p>
            </div>
