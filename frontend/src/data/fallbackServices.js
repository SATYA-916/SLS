export const fallbackServices = [
  ...
  },
  {
    ...
    description: 'On-site quality audits, alignment verification, lifting plan review, non-destructive testing (NDT) inspection, and coordination to ensure compliance with AFC drawings.',
    icon: 'clipboard',
  },
  {
    id: 12,
    title: 'Municipality Relation Services',
    description: 'Regulatory liaisoning, building NOC approvals, structural stability certificates, and compliance coordination with regional municipal authorities.',
    icon: 'activity',
  },
  {
    id: 13,
  ...
  },
  {
    ...
    description: 'Advanced computational stress, thermal expansion, fatigue, and vibration analysis for heavy vessels, heaters, and components using advanced FEA software.',
    icon: 'cpu',
  },
  {
    id: 15,
